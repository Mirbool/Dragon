namespace Config
{
    public class ConfigManager
    {
        ...
        {
            Newtonsoft.Json.Utilities.AotHelper.EnsureList<RoleInfoConfig>();
        ...
        {
            Config.RoleInfoConfig.DeserializeByAddressable(directory);
        ...
        {
            Config.RoleInfoConfig.DeserializeByFile(directory);
        ...
        {
            yield return Config.RoleInfoConfig.DeserializeByBundle(directory, subFolder);
